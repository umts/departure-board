...
describe("App", () => {
  ...
  it("only renders departures for configured stops", async () => {
    ...
    await expect
      .element(locateDeparture(page, "MR", "My trip", "12:05 pm"))
  ...
  it("only renders departures for configured routes when provided", async () => {
    ...
    await expect.element(stop).toBeVisible();
    await expect
      .element(locateDeparture(page, "R1", "Trip one", "12:05 pm"))
      .not.toBeInTheDocument();
  ...
  it("only renders scheduled departures", async () => {
    ...
    await expect
      .element(locateDeparture(page, "MR", "My trip", "12:01 pm"))
      .not.toBeInTheDocument();
    await expect
      .element(locateDeparture(page, "MR", "My trip", "12:02 pm"))
      .not.toBeInTheDocument();
    await expect
      .element(locateDeparture(page, "MR", "My trip", "12:03 pm"))
      .not.toBeInTheDocument();
    ...
    await expect
      ...
      .not.toBeInTheDocument();
    await expect
      .element(locateDeparture(page, "MR", "My trip", "12:06 pm"))
      .not.toBeInTheDocument();
    await expect
  ...
  it("only renders departures in the future", async () => {
    ...
    await expect.element(stopOne).toBeVisible();
    await expect
      .element(locateDeparture(page, "MR", "My trip", "11:58 am"))
      .not.toBeInTheDocument();
    ...
    await expect.element(stopTwo).toBeVisible();
    await expect
      .element(locateDeparture(page, "MR", "My trip", "11:59 am"))
      .not.toBeInTheDocument();
  ...
  it("only renders the earliest departures for any given route and headsign", async () => {
    ...
    await expect
      .element(locateDeparture(page, "MR", "Trip one", "12:03 pm"))
      .not.toBeInTheDocument();
    ...
    await expect
      .element(locateDeparture(page, "MR", "Trip one", "12:04 am"))
      .not.toBeInTheDocument();
  ...
  it("does not render the last stop in each trip", async () => {
    ...
    await expect.element(stopTwo).toBeVisible();
    await expect
      .element(locateDeparture(stopTwo, "MR", "Trip one", "12:08 pm"))
      .not.toBeInTheDocument();
        ...
        entity: [
          {
            alert: {
              informedEntity: [
                { stopId: "MY_STOP", routeId: "MY_ROUTE" },
                { routeId: "OTHER_ROUTE" },
              ],
              headerText: { translation: [{ text: "My header" }] },
              descriptionText: { translation: [{ text: "My description" }] },
